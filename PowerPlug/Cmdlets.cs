...
namespace PowerPlug
{
    ...
    [Alias("nbn")]
    public class NewBynameProfileAlias : WritableBynameBase
    {
        ///<inheritdoc cref="PowerPlug.BaseCmdlets.BynameBase"/>
        protected override void ProcessRecord()
        {
           new NewBynameCreator(this).Execute();
        }
    }
    ...
    public class SetBynameProfileAlias : WritableBynameBase
    {
        ...
        protected override void ProcessRecord()
        {
            new SetBynameCreator(this).Execute();
        }
    }
    ...
    public class RemoveBynameProfileAlias : BynameBase
    {
        ...
        protected override void ProcessRecord()
        {
            new RemoveBynameCreator(this).Execute();
        }
    }
}
