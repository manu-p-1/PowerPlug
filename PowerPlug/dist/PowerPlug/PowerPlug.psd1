# Module manifest for module 'PowerPlug'
...
Copyright = '(c) Manu Puduvalli. All rights reserved.'

# Description of the functionality provided by this module
Description = 'PowerPlug - Simple cmdlets for PowerShell'
...
FileList = @('license.txt', 'PowerPlug.dll', 'PowerPlug.dll-Help.xml')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('powershell', 'utilities', 'cmdlets')

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/manu-p-1/PowerPlug/blob/master/LICENSE'
